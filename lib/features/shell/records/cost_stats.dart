...
//    不变量由写 seam（关联行 companion 内置 normalizeItemCost）单点
//    保证（2026-09-21 拍板删除读侧兜底分支，2026-09-25 写侧收编单点，
//    口径唯一）；
...
/// 项目费用必有值"的不变量由写 seam（关联行 companion 内置
/// normalizeItemCost）单点保证（2026-09-21 拍板删除兜底分支，
/// 2026-09-25 写侧收编单点）。这是项目占比、优惠分摊、项目档案共用
/// 的唯一口径实现点。
